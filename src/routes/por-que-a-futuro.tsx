...
export const Route = createFileRoute("/por-que-a-futuro")({
  head: () => ({
    meta: [
      { title: "Por que a Futuro — Assessoria de crédito imobiliário" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Por que a Futuro" },
      {
...
function Missao() {
  const valores = [
    {
      t: "Transparência",
      d: "Cada etapa explicada com clareza — sem letras miúdas, sem surpresas.",
    },
    {
      t: "Agilidade",
      d: "Processos organizados e prazos previsíveis para você decidir com segurança.",
    },
    {
      t: "Segurança",
      d: "Um caminho estruturado, com acompanhamento técnico em cada decisão.",
    },
    {
      t: "Do início ao fim",
      d: "Da análise de crédito à liberação dos recursos, tudo em um só lugar.",
    },
    {
      t: "Tecnologia",
      d: "Uma plataforma que centraliza documentos, status e atualizações em tempo real.",
    },
    {
      t: "Atendimento humano",
      d: "Especialistas próximos, que traduzem o financeirês em decisões possíveis.",
    },
  ];
