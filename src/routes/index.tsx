    ...
    <section id="top" className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-5 pt-20 pb-24 md:pt-32 md:pb-36">
        <div className="grid md:grid-cols-2 gap-10 md:gap-14 items-center">
          <div>
            <h1 className="text-5xl md:text-7xl font-bold leading-[1.02] text-balance lowercase">
              mais crédito,
              <br />
          ...
          <div className="relative">
            <div className="absolute -inset-4 bg-gradient-brand rounded-[2rem] opacity-20 blur-2xl" aria-hidden />
            <img
              src={familiaEmCasa}
              alt="Família reunida em casa"
              width={1200}
              height={1408}
              className="relative w-full h-auto rounded-3xl object-cover shadow-soft"
            />
          </div>
        </div>
      </div>
